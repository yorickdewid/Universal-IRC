...
using UniversalIRC.Activation;
using UniversalIRC.EventHandlers;
    ...
    internal class SuspendAndResumeService : ActivationHandler<LaunchActivatedEventArgs>
    {
        ...
        public async Task<bool> SaveStateAsync()
        {
            ...
            try
            {
                ...
                var onBackgroundEnteringArgs = new OnBackgroundEnteringEventArgs(new SuspensionState(), target);
        ...
        {
            OnSuspending?.Invoke(this, EventArgs.Empty);
        }
